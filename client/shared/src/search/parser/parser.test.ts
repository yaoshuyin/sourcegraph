...
describe('scanBalancedPattern()', () => {
    ...
    test('not recognized, starts with a not operator', () => {
        expect(scanBalancedPattern(PatternKind.Literal)('(not chocolate)', 0)).toMatchInlineSnapshot(
    ...
    test('balanced, no conflicting tokens', () => {
        expect(scanBalancedPattern(PatternKind.Literal)('(bor band )', 0)).toMatchInlineSnapshot(
